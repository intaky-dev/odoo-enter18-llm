...
Si **no quieres construir la imagen manualmente**, simplemente **pullea la imagen preconstruida** desde [Docker Hub](https://hub.docker.com/repository/docker/klap50/odoo18-enterprise/general):
